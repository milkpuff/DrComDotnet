...
```Python
    [ 314 : passLen +314 ] = ror #长度==passLen
    [ passLen +314 ] = 0x02
    [ passLen +315 ] = 0x0c
    [ passLen +316 : passLen +319 ] = checksum[0:3]
    [ passLen +320 ] = 0
    [ passLen +321 ] = 0
    [ passLen +322 : passLen + 327 ] = mac[0:7]
    [ passLen +328 : passLen + zeroCount ] = [0] * zeroCount
    # zeroCount = (4 - passLen % 4) % 4
    [328 + passLen + zeroCount :: 2 ] = [rand1,rand2]
